  ...
  const float iniVolt = x.xx; //ACS758 inial voltage w/o current flow. calibrate if needed.
  ...
  for(int i = 0; i < 1000; i++) 
  {
    ...
    float cur = (voltage-iniVolt)/0.04; //sensitivity of 50A ACS758 is 0.04 V/A
  ...
  output_voltage = 1.23*output_voltage;
